...
\begin{quote}
		...
		\begin{quote}
            ...
            Der Versuchsaufbau im 8.Termin des Praktikums ähnelte zwar der
            gleich Aufbau wie im 7.Termin. Anstatt aber den
            Motorstrom und das Tachosignal aufzunehmen, maßen wir nur den Strom
            (AC- und DC-Anteil) des fehlerfreien Universalmotors. Dieses
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_hochlaufen_Haar_Wavlet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 2}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_hochlaufen_Daubechies_Wavlet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 2}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_hochlaufen_Haar_Wavlet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 4}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_hochlaufen_Daubechies_Wavlet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 4}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_hochlaufen_Haar_Wavlet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 5}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_hochlaufen_Daubechies_Wavlet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 5}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesaettigt_Haar_Wavlet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 2}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesaettigt_Daubechies_Wavlet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 2}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesaettigt_Haar_Wavlet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 4}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesaettigt_Daubechies_Wavlet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 4}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesaettigt_Haar_Wavlet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 5}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesaettigt_Daubechies_Wavlet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 5}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesaettigt_Spektrum.pdf}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 1}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/fehlerfrei_gesättigt_Spectrogam.pdf}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 1}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/lamellenfehler_gesaettigt_Haar_Wavlet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 2}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/lamellenfehler_gesaettigt_Daubechies_Wavlet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 2}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/lamellenfehler_gesaettigt_Haar_Wavlet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 4}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/lamellenfehler_gesaettigt_Daubechies_Wavlet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 4}
                        \end{figure}
                ...
                \hspace{-8em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/lamellenfehler_gesaettigt_Haar_Wavlet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Haar-Wavelet Zerlegung, Level 5}
                        \end{figure}
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.4, trim = 2cm 6cm 1cm
                            7.5cm,
                            clip]{./Bilder/Termin8/lamellenfehler_gesaettigt_Daubechies_Wavlet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
                            \caption{Daubechies-Wavelet Zerlegung, Level 5}
                        \end{figure}
