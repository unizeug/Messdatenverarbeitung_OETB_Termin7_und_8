                ...
                \hspace{-12em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Haar_Wavelet_lvl_1}
                            %FIXME [width=640px,
                             %height=474px]
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Daubechies_Wavelet_lvl_1}
                            %FIXME [width=640px,
                             %height=474px]
                ...
                \hspace{-12em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Haar_Wavelet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Daubechies_Wavelet_lvl_2}
                            %FIXME [width=640px,
                             %height=474px]
                ...
                \hspace{-12em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Haar_Wavelet_lvl_3}
                            %FIXME [width=640px,
                             %height=474px]
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Daubechies_Wavelet_lvl_3}
                            %FIXME [width=640px,
                             %height=474px]
                ...
                \hspace{-12em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Haar_Wavelet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Daubechies_Wavelet_lvl_4}
                            %FIXME [width=640px,
                             %height=474px]
                ...
                \hspace{-12em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Haar_Wavelet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
                    ...
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            ...
                            \includegraphics[scale=0.45, trim = 0.8cm 7cm 3cm
                            8.5cm,
                            clip]{./Bilder/Termin8/Daubechies_Wavelet_lvl_5}
                            %FIXME [width=640px,
                             %height=474px]
