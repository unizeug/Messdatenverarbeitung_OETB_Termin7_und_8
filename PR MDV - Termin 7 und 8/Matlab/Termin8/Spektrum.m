...
%AXIS([-1000 1000 -70 10])%f�r die Praxisaufgabe  5.x
%AXIS([-1000 1000 0 1.5])%f�r die Praxisaufgabe  6.x
%AXIS([-1000 1000 0 1.5])%f�r die Vorbereitungsaufgabe 2
...
%AXIS([-1000 1000 min(PhaseXf)*1.2 max(PhaseXf)*1.2])%F�r die Praxisaufgabe 5.x
%AXIS([-1000 1000 -0.015 0.015])%F�r die Vorbereitungsaufgabe 2
